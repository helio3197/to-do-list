...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"addTask\": () => (/* binding */ addTask),\n/* harmony export */   \"removeTask\": () => (/* binding */ removeTask),\n/* harmony export */   \"editTask\": () => (/* binding */ editTask)\n/* harmony export */ });\n/* harmony import */ var _sort_taks_array_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sort-taks-array.js */ \"./src/sort-taks-array.js\");\n\n\nconst addTask = (list, description) => {\n  const newtask = {\n    description,\n    completed: false,\n    index: list.length + 1,\n  };\n  list.push(newtask);\n  localStorage.setItem('taskList', JSON.stringify(list));\n\n  return list;\n};\n\nconst removeTask = (list, index) => {\n  list.splice(index, 1);\n  list = (0,_sort_taks_array_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(list);\n  localStorage.setItem('taskList', JSON.stringify(list));\n\n  return list;\n};\n\nconst editTask = (list, value, index) => {\n  list[index].description = value;\n  localStorage.setItem('taskList', JSON.stringify(list));\n\n  return list;\n};\n\n\n\n\n//# sourceURL=webpack://webpack-boilerplate/./src/task-list-features.js?");
